...
namespace Bricks.Core.Impl.Web
{
	...
	internal class WebClientImpl : IWebClient
	{
		...
		public async Task<IWebResponse> ExecuteRequestAsync(Uri address, HttpMethod method, NameValueCollection data = null, IEnumerable<KeyValuePair<HttpRequestHeader, string>> headers = null, TimeSpan? timeout = null)
		{
			if (!timeout.HasValue)
			{
