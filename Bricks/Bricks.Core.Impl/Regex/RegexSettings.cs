...
namespace Bricks.Core.Impl.Regex
{
	...
	internal sealed class RegexSettings : ConfigurationSection, IRegexSettings
	{
		...
		public EmailRegexSettings Email
		{
			get
			{
				return (EmailRegexSettings)this[EmailName];
			}
		}
		...
		public PhoneRegexSettings Phone
		{
			get
			{
				return (PhoneRegexSettings)this[PhoneName];
			}
		}
		...
		public double MatchTimeout
		{
			get
			{
				return (double)this[MatchTimeoutName];
			}
		}
		...
		TimeSpan IRegexSettings.MatchTimeout
		{
			get
			{
				return TimeSpan.FromMilliseconds(MatchTimeout);
			}
		}
